...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(msg.sender == _owner, 'This should be called by owner only!');
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOf(tokenId), 'To address is the owner of the given token!');
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == ownerOf(tokenId), 'Sender is not the owner of the given token!');
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(to != address(0), 'Provided address is invalid');
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), 'Token can be trnsferred by owner only!');
        // TODO: require token is being transfered to valid address
        require(to != address(0), 'Token must be trasnfered to a valid address!');
        // TODO: clear approval
